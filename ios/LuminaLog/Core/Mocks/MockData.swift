...
enum MockData {
    ...
    static let cannedMirrorEchoes = GeneratedMirrorEchoes(
        morning: "You named the hard part on Monday, so start there before the day fills up around it.",
        afternoon: "The friction you are feeling now is the goal from spring asking to be worked, not avoided.",
        evening: "You slowed down on purpose today and the week still held, let that count as progress."
    )
