...
type Social = {
  ...
  title: string
  icon: 'x' | 'instagram' | 'youtube' | 'spotify' | 'github' | 'telegram'
}

/* The community chat. Exported because it is linked from the nav, the landing
 * hero, and the card-game page as well as the footer row below, and one wrong
 * handle in four places is four bugs. */
export const TELEGRAM_HREF = 'https://t.me/myargoquest'

export const SOCIALS: Social[] = [
  { label: 'Telegram', href: TELEGRAM_HREF, title: 'Argo community on Telegram', icon: 'telegram' },
