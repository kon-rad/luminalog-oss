...
export const metadata: Metadata = {
  ...
  description:
    'The live first session of AI Agent Pro. Install a complete private AI stack (offline speech-to-text, Obsidian, the Hermes agent, and a private Morpheus model) and build your first agent skill. Free, no coding required.',
}
    ...
    <CourseLayout>
      ...
      <section style={{ background: 'var(--surfaceAlt)', borderTop: '1px solid var(--hairline)', borderBottom: '1px solid var(--hairline)' }}>
        <div className="wrap" style={{ padding: '64px 0', maxWidth: 800 }}>
          ...
          <CourseQuiz
            quizId="module-1"
            quizTitle="AI Agent Pro · Module 1"
            mcq={MODULE_1_MCQ}
