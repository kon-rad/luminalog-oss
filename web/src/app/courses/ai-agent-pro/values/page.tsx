...
export const metadata: Metadata = {
  title: 'Values, AI Agent Pro, Argo',
  description:
    'The three values that set the culture of the AI Agent Pro course: win and help win, the four agreements, and praise in public, criticise in private.',
}
      ...
      <section style={{ borderBottom: '1px solid var(--hairline)', background: 'var(--surfaceAlt)' }}>
        <div className="wrap" style={{ padding: '72px 0 48px', textAlign: 'center' }}>
          ...
          <p style={{ fontSize: 18.5, lineHeight: 1.6, color: 'var(--text2)', maxWidth: 620, margin: '0 auto' }}>
            ...
            shape every lab, every critique, and every feedback circle in the AI Agent Pro
            course.
          </p>
        </div>
      </section>
