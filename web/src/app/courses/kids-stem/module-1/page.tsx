    ...
    <CourseLayout>
      ...
      <section style={{ borderBottom: '1px solid var(--hairline)', background: 'var(--surfaceAlt)' }}>
        <div className="wrap" style={{ padding: '72px 0 56px', textAlign: 'center' }}>
          ...
          >
            Learning from examples, explained for every age, with the story of how we got here and where it
            might go next.
          </p>
      ...
      <section id="history" style={{ scrollMarginTop: 96 }}>
        <div className="wrap" style={{ padding: '52px 0 8px', maxWidth: 820 }}>
          ...
          <p style={{ fontSize: 16.5, lineHeight: 1.65, color: 'var(--text2)', margin: '14px 0 30px' }}>
            Tell this as a story with characters, not a list of dates. The kids remember the people. Three or
            four beats is plenty for the little ones; the older kids can take the whole arc.
          </p>
      ...
      <section id="future" style={{ scrollMarginTop: 96 }}>
        <div className="wrap" style={{ padding: '52px 0 8px', maxWidth: 820 }}>
          ...
          <p style={{ fontSize: 16.5, lineHeight: 1.65, color: 'var(--text2)', margin: '14px 0 26px' }}>
            Frame this honestly: nobody knows, and the experts genuinely disagree. That is not a cop-out. It
            is the most scientifically accurate thing you can tell them, and it invites them to have an
