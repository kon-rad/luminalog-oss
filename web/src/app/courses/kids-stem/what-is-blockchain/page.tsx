      ...
      <section style={{ borderBottom: '1px solid var(--hairline)', background: 'var(--surfaceAlt)' }}>
        <div className="wrap" style={{ padding: '72px 0 56px', textAlign: 'center' }}>
          ...
          <p style={{ fontSize: 19, lineHeight: 1.6, color: 'var(--text2)', maxWidth: 660, margin: '0 auto' }}>
            The notebook nobody can erase, explained for every age, with the story
            of how we got here and an honest look at what it cannot do.
          </p>
      ...
      <section id="prompts" style={{ scrollMarginTop: 96 }}>
        <div className="wrap" style={{ padding: '52px 0 8px', maxWidth: 900 }}>
          ...
          <p style={{ fontSize: 16.5, lineHeight: 1.65, color: 'var(--text2)', margin: '14px 0 30px', maxWidth: 700 }}>
            One for the hands, one for the head. Read each prompt out whole, then give
            each child the version that fits them. Every level is doing the same thing,
          ...
          <div className="grid grid-cols-1 md:grid-cols-2" style={{ gap: 20 }}>
            ...
            <div className="card" style={{ padding: '24px 26px' }}>
              ...
              <p
                className="serif"
                style={{ fontSize: 18, lineHeight: 1.55, color: 'var(--text)', fontStyle: 'italic', marginBottom: 18 }}
              >
                “{MODULE_2_DRAWING_PROMPT}”
              </p>
      ...
      <section id="history" style={{ scrollMarginTop: 96 }}>
        <div className="wrap" style={{ padding: '52px 0 8px', maxWidth: 820 }}>
          ...
          <p style={{ fontSize: 16.5, lineHeight: 1.65, color: 'var(--text2)', margin: '14px 0 30px' }}>
            Tell it as a story about a problem: how do you send something valuable to a
            stranger, over the internet, with nobody in the middle? For thirty years,
            very clever people chipped away at it, and then somebody nobody can name
              ...
              <ul className="flex flex-col" style={{ gap: 11, listStyle: 'none', padding: 0, margin: 0 }}>
                {BLOCKCHAIN_CAN.map((c) => (
                  <li key={c} className="flex gap-2.5" style={listItem}>
                    <Check style={{ width: 16, height: 16, flexShrink: 0, marginTop: 4, color: 'var(--accentDeep)' }} />
                    <span>{c}</span>
                  </li>
                ))}
              </ul>
      ...
      <section id="future" style={{ scrollMarginTop: 96 }}>
        <div className="wrap" style={{ padding: '52px 0 8px', maxWidth: 820 }}>
          ...
          <p style={{ fontSize: 16.5, lineHeight: 1.65, color: 'var(--text2)', margin: '14px 0 26px' }}>
            Frame this the same way as the AI class: nobody knows, and the experts
            genuinely disagree. That is not a cop-out. It is the most accurate thing
            you can tell them, and it invites them to have an opinion of their own.
          </p>
          ...
          <div className="card" style={{ padding: '24px 26px', marginTop: 20 }}>
            ...
            <p style={{ fontSize: 16, lineHeight: 1.65, color: 'var(--text2)' }}>{BLOCKCHAIN_OPEN_ARGUMENT}</p>
          </div>
