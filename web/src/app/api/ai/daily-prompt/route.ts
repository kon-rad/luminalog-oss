...
// /v1/ai/daily-prompt (design §2) — plaintext daily prompt generation.
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const res = await fetch(`${API_URL}/v1/ai/daily-prompt`, {
      method: 'POST',
    ...
    console.error('[api/ai/daily-prompt] proxy failed', err)
