...
// /v1/ai/summary (design §2) — plaintext summary generation, not persisted here.
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const res = await fetch(`${API_URL}/v1/ai/summary`, {
      method: 'POST',
    ...
    console.error('[api/ai/summary] proxy failed', err)
