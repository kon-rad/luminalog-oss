...
// /v1/rag/search/semantic (design §2) — server-decrypted cosine-similarity search.
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const res = await fetch(`${API_URL}/v1/rag/search/semantic`, {
      method: 'POST',
    ...
    console.error('[api/rag/search/semantic] proxy failed', err)
