...
// /v1/rag/index (design §10) — fire-and-forget from the caller's perspective.
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const res = await fetch(`${API_URL}/v1/rag/index`, {
      method: 'POST',
    ...
    console.error('[api/rag/index] proxy failed', err)
