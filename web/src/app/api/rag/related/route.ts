...
// /v1/rag/related (design §2) — server-decrypted related-entry results.
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const res = await fetch(`${API_URL}/v1/rag/related`, {
      method: 'POST',
    ...
    console.error('[api/rag/related] proxy failed', err)
