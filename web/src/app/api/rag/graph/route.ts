...
// /v1/rag/graph (design §2 M8-T2) — server-decrypted JournalGraph {nodes,links}
// for the Constellation 3D similarity graph.
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const res = await fetch(`${API_URL}/v1/rag/graph`, {
      method: 'POST',
    ...
    console.error('[api/rag/graph] proxy failed', err)
