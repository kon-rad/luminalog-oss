...
import SocialLinks, { TELEGRAM_HREF } from '@/components/SocialLinks'
              ...
              <div id="download" style={{ marginTop: 34 }}>
                ...
                <div style={{ marginTop: 14, display: 'flex', flexWrap: 'wrap', gap: 16, alignItems: 'center' }}>
                  ...
                  <a
                    ...
                    style={{ display: 'inline-flex', alignItems: 'center', gap: 6, color: 'var(--accent)', fontSize: 15, fontWeight: 600 }}
                  >
